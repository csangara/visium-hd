...
coronal_visualign_map <- load.image("data/Visium_HD_MouseBrain/QUINT/tissue_8um_lowres_image_nl.png")
...
# Load Visium image
coronal_visium_img <- load.image("data/Visium_HD_MouseBrain/binned_outputs/square_008um/spatial/tissue_lowres_image.png")
...
# Load scale factors
scale_factors <- fromJSON("data/Visium_HD_MouseBrain/binned_outputs/square_008um/spatial/scalefactors_json.json")

# Load Visium coordinates
coronal_visium_coords <- arrow::read_parquet("data/Visium_HD_MouseBrain/binned_outputs/square_008um/spatial/tissue_positions.parquet") %>% 
...
# Save the metadata
saveRDS(coords_to_region, "data/Visium_HD_MouseBrain/tissue_positions_with_annotations_008um.rds")
