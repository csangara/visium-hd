...
df <- read.csv("/data/gent/vo/000/gvo00070/vsc43831/spatial_datasets/ABA_data/cell_metadata_with_cluster_annotation.csv")
...
write.csv(downsampled_df, "/data/gent/vo/000/gvo00070/vsc43831/spatial_datasets/ABA_data/cell_metadata_with_cluster_annotation_downsampled.csv", row.names = FALSE)