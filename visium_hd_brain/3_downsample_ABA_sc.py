...
downsampled_csv = os.environ['VSC_DATA_VO_USER'] + '/spatial_datasets/ABA_data/cell_metadata_with_cluster_annotation_downsampled.csv'
output_folder = os.environ['VSC_DATA_VO_USER'] + '/spatial_datasets/ABA_data/subset/'
