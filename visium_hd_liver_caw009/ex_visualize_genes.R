...
null_dist_lr <- readRDS(file = paste0("visium_hd_liver", dataset, "null_dist_1000LR_distance_", bin_size_str, ".rds"))
...
ligand_points_df <- ligand_points %>%
  ...
  bind_cols(genes_oi_mat["Bmp10", .$cell] %>% data.frame(count=.))
