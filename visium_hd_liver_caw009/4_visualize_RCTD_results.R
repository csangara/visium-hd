...
roi <- c(8000, 10000, 10000, 12000)
#roi <- c(9000, 11000, 8000, 10000)
...
ggsave(paste0(plot_path, "spatialdimplot_ROI", roi_name, "_", bin_size_str, ".png"),
...
plot_scatterbar(deconv_props_df, square_size, color_palette = color_palette)
