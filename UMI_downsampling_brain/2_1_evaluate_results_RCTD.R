...
doublet_props <- read.table(paste0("UMI_downsampling_brain/brain_cortex_generation_real/proportions_rctd_brain_cortex_generation_real_rep",
                                   repl, "_2.2.1-hd-seurat5.1.0"), header = TRUE)
doublet_info <- read.table(paste0("UMI_downsampling_brain/brain_cortex_generation_real/proportions_rctd_brain_cortex_generation_real_rep",
...
ggsave("UMI_downsampling_brain/plots/spotclass_accuracy_per_bin.png", width=8, height=8, dpi=300)
...
ggplot(class_metrics_df %>% filter(name=="F1", type %in% c("singlet", "doublet_certain")),
  ...
  theme(legend.position.inside=c(0.15, 0.9),
        legend.position="inside")
ggsave("UMI_downsampling_brain/plots/spotclass_F1_per_bin.png", width=8, height=8)
...
ggsave("UMI_downsampling_brain/plots/spotclass_confusion_matrix_per_bin.png", 
...
ggplot(doublet_info, aes(x=singlet_score, y=min_score, color=factor(spot_class, levels=classes))) +
  ...
  theme_classic()
ggsave("UMI_downsampling_brain/plots/singlet_vs_min_score.png", width=8, height=5)
...
ggsave("UMI_downsampling_brain/plots/spotclass_proportion_per_bin.png", width=8, height=5)
...
ggplot(prc, aes(x=factor(dsids), y=aucs)) +
  ...
  theme_classic(base_size=24)
ggsave("UMI_downsampling_brain/plots/celltype_AUPR_per_bin.png", width=8, height=8)
...
ggsave("UMI_downsampling_brain/plots/boxplot_celltype_AUPR_per_spotclass_per_bin.png", width=6, height=4)
