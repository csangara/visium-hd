...
if args.first_run:
    sdata = spatialdata_io.visium_hd(base_path + 'spatial_datasets/Visium_HD_Liver',
    ...
    print(sdata)
    sdata.write(base_path + 'spatial_datasets/Visium_HD_Liver/Visium_HD_Liver_zarr')
    ...
    sdata = sd.read_zarr(base_path + 'spatial_datasets/Visium_HD_Liver/Visium_HD_Liver_zarr')

print(sdata)

print(f"Running {score_genes_func.__name__}...")
score_genes_func(sdata, labels_layer="Visium_HD_Liver_square_008um_labels",
...
adata = ad.read_zarr(f"{base_path}spatial_datasets/Visium_HD_Liver/Visium_HD_Liver_zarr/tables/{output_layer_name}")
