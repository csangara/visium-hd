...
synth_obj <- readRDS(paste0("UMI_downsampling_liver/synthetic_data/liver_mouseStSt_exVivo_9celltypes_annot_cd45_artificial_dominant_celltype_diverse_rep", repl, ".rds"))
